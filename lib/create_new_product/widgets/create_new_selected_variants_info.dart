...
import 'package:inventory_management_with_sql/create_new_product/widgets/product_inventory_button.dart';
...
class CreateNewSelectedVariantsInfo extends StatelessWidget {
  const CreateNewSelectedVariantsInfo({super.key});
